...
<header>
  <nav class="navbar navbar-default">
    ...
    <div class="navbar-header"><a class="navbar-brand" href="#">Photoアップロード</a></div>
      <ul class="pager">
      <li class="previous"><a href="file_chek.html">← カメラ／Photo選択</a></li>
      <li class="next disabled"><a href="file_view.php">Photo一覧</a></li>
      </ul>
     </div>
  </nav>
</header>
