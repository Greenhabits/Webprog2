...
try {
    ...
    $pdo = new PDO('mysql:dbname=map_db;charset=utf8mb4;host=localhost:3308','root','');
...
<script src='https://www.bing.com/api/maps/mapcontrol?callback=GetMap&key=AjQpprwglsUxJKmVtBXY29swayrAX_pHuKAnFg6ppI1R-dpqSHERUwfEX-dVGu_0' async defer></script>
...
function GetMap(){
    //BingMapスタート
    map = new Bmap("#myMap");
    map.startMap(35.682567, 139.766148, "load", zoom); //The place is Bellevue.
